...
# GET DATA -------------------
$message=$once->once_select_item_key('plugins_reports','plugin_id');
...
echo '
<div id="plugin-data" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" data-id="'.$_GET['id'].'">';
}
?>
	<div class="container">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><i class="fa fa-cube"></i> Plugin edit
						...
						<a href="plugins/<?php echo $_GET['id'];?>/index.php" target="_blank" class="btn btn-default btn-sm pull-right item-link" type="button"><i class="fa fa-link"></i> Preview</a>
						<?php
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs">
								...
								<?php
									if($_SERVER['HTTP_HOST']!='oncebuilder.com' || $data['item']['published']==1){
														...
														<div class="row">
															<div class="col-md-12">
																<div class="thumbnail">
																	...
																	<img id="item-thumbnail" src="plugins/<?php echo $_GET['id'];?>/thumbnail.png?<?php echo time();?>" onerror="this.src='img/plugin.png'">
																</div>
															</div>
														</div>
													</div>
...
<script type="text/javascript">
	$(document).ready(function () {
		// Initialize actions
		once.plugins.actions.editInit($(this));
	});
</script>