...
# DECLARE SORT ARRAY -------------------
$data_sources=array('','source_ui','source_php','source_css','source_js','source_ajax','source_class');
$data_sources_titles=array('','Plugin UI','PHP','CSS','JS');
$data_sources_count=count($data_sources_titles);

# GET REMOTE DATA -------------------
$data=$once->item_preview();a($data);
?>
		...
		<div class="modal-dialog" style="width: 100%;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><i class="fa fa-chain-broken"></i> Plugin preview
					<?php 
								...
								<?php
									if($data['item']['price']==0 || $data['item']['bought']){
										for($i=1;$i<$data_sources_count;$i++){
											echo '<li role="presentation"><a href="#edit_source" aria-controls="edit_source" role="tab" data-toggle="tab" data-source="'.$i.'">'.$data_sources_titles[$i].'</a></li>';
										}
									}
								?>
...
<script type="text/javascript">
	$(document).ready(function () {
		// Initialize actions
		once.libraries.actions.previewInit($(this));
	});
</script>