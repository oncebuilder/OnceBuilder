...
?>
	<div class="container" id="theme-data" data-id="<?php echo $_GET['id'];?>">
		<div class="modal-dialog" style="width: 100%;">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title"><i class="fa fa-chain-broken"></i> Theme publish</h4>
				</div>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs">
								<li role="presentation" class="<?php echo (isset($_GET['id'])==true?'hidden':'active');?>"><a href="#publish_select" aria-controls="publish_select" role="tab" data-toggle="tab">Select theme</a></li>
											...
											<div class="table-responsive">
												<table id="tablelist" class="table table-bordered table-striped table-mailbox">
													...
													echo '
														...
														echo '
														<thead>
															<th>Not found any theme here, be first and create it once!</th>
														</thead>';
													}
													?>
												</table>
											...
											<div class="row">
												...
												<div class="col-md-3">
													...
													<div class="row">
														<div class="col-md-12">
															<div class="thumbnail">
																<img src="themes/<?php echo $data['item']['id'];?>/thumbnail.png?<?php echo time();?>" onerror="this.src='img/theme.png'">
															</div>
														</div>
													</div>
												</div>
...
<script type="text/javascript">
	$(document).ready(function () {
		// Initialize actions
		once.themes.actions.publishInit($(this));
	});
</script>