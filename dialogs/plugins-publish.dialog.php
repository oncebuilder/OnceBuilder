...
# GET DATA -------------------
if(isset($_GET['id'])){
	$data=$once->once_select_item('plugins');
}else{	
	$data=$once->once_select_items_page('plugins');
}

#GET DATA -------------------
$once->category_get('plugins');
...
?>
	<div class="container" id="plugin-data" data-id="<?php echo $_GET['id'];?>">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs">
								<li role="presentation" class="<?php echo (isset($_GET['id'])==true?'hidden':'active');?>"><a href="#publish_select" aria-controls="publish_select" role="tab" data-toggle="tab">Select plugin</a></li>
											...
											<div class="table-responsive">
												<table id="tablelist" class="table table-bordered table-striped table-mailbox">
													...
													echo '
														...
														echo '
														<thead>
															<th>Not found any plugin here, be first and create it once!</th>
														</thead>';
													}
													?>
												</table>
											...
											<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<select disabled class="form-control" name="category_id">
																		<option value="0" <?php echo ($data['item']['category_id']==0?'selected':'');?>></option>
																		<?php
																			if($categories['items']){
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<select disabled class="form-control" name="fw_css">
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<select disabled class="form-control" name="fw_js">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<input disabled type="text" value="<?php echo ($data['item']['author_url']==''?'':$data['item']['author_url']);?>" class="form-control" name="author_url" placeholder="If you made that leave it blank">
																</div>
															</div>
															<div class="col-md-6">
																<label for="price">Price</label>
																<div class="input-group">
																	<input disabled type="text" value="<?php echo $data['item']['price']==0?'':$data['item']['price'];?>" class="form-control"name="price" placeholder="Enter price if you want to earn some" aria-label="Amount (to the nearest dollar)">
												...
												<div class="col-md-3">
													...
													<div class="row">
														<div class="col-md-12">
															<div class="thumbnail">
																<img src="plugins/<?php echo $data['item']['id'];?>/thumbnail.png?<?php echo time();?>" onerror="this.src='img/plugin.png'">
															</div>
														</div>
													</div>
												</div>
...
<script type="text/javascript">
	$(document).ready(function () {
		// Initialize actions
		once.plugins.actions.publishInit($(this));
	});
</script>