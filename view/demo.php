	...
	<div class="col-md-12">
		<div class="box">
			<div id="content-body" class="box-body margin">
				<p>This is demo of OnceBuilder CMS Beta</p>
				</br>
				<p>We apocalize that view dislay and most of the functions are blocked for security reason, enjoy it after you download our Admin LTE based open source project</p>
				</br>
				<p>Idea about building site with HTML blocks appread in 2012!</p>
