...
?>
<div id="images-data" class="box" data-ajax="true" data-c="<?php echo $_GET['c'];?>" data-o="<?php echo $_GET['o'];?>" data-path="<?php echo $data['path'];?>" data-query="<?php echo $_GET['query'];?>">
	<div class="row box-header">
		<div class="col-md-8">
			<ol class="breadcrumb">
				<li><a href="#" class="item-open" data-path=""><i class="fa fa-file-image-o"></i> &nbsp;Images</a></li>
				<?php
...
<script type="text/javascript">
	$(document).ready(function () {
		// Initialize actions
		once.images.actions.mainInit($(this));
	});
</script>