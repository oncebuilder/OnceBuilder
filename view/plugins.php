...
<div class="row">
	<div id="categories-data" class="col-md-'.($_GET['v']=='installed'?'3':'12 hidden').'">
		<ul class="list-group nav nav-pills nav-stacked">
			<li class="header">Plugins categories
				...
				<li class="list-group-item current" data-id="0">
					<div class="list-group-header"><i class="fa fa-bars"></i><span>All plugins</span></div>
				</li>';
	...
	<div id="content-body" class="col-md-'.($_GET['v']=='installed'?'9':'12').'">
		<script type="text/javascript">
			$(function() {
				$.get("view.php?c='.($_GET['route']==''?'plugins':$_GET['route']).'&o='.($_GET['v']==''?'installed':$_GET['v']).'", function(data) {
...
<script src="js/once.plugins.js" type="text/javascript"></script>';
$obj['html']=$str;
