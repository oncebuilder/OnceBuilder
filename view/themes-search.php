...
# GET DATA -------------------
//$categories=$once->category_get('themes');
...
# GET REMOTE DATA -------------------
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://oncebuilder.com/once/ajax.php?c=themes&o=api_search&type_id=".$_GET['type_id']."&category_id=".$_GET['category_id']."&sort_by=".$_GET['sort_by']."&page=".$_GET['page']."&ids=".$_GET['ids']."&query=".$_GET['query']."");
			...
			foreach($data['items'] as $key => $val){
				...
				<div class="col-md-4">
					<div class="theme-item">
						...
						<div class="row theme-footer" id="item_'.$data['items'][$key]['id'].'" data-id="'.$data['items'][$key]['id'].'">
							<div class="col-md-6 theme-name">
								'.$data['items'][$key]['name'].'  
							</div>
							<div class="col-md-6">
								<button type="button" class="btn btn-sm pull-right item-preview"><i class="fa fa-eye"></i> &nbsp;&nbsp;&nbsp; Preview</button>
							</div>
						</div>
					</div>
				</div><!-- /.col -->';
