...
<div class="row">
	<div id="content-body" class="col-md-12">
		<script type="text/javascript">
			$(function() {
				$.get("view.php?c='.($_GET['route']==''?'images':$_GET['route']).'&o='.($_GET['v']==''?'dir':$_GET['v']).'", function(data) {
					$("#content-body").html(data);
				})
				.error(function() { console.log("View Error: images"); });
			});
		</script>
	</div>
</div><!-- /.row -->
<script src="js/once.images.js" type="text/javascript"></script>';
$obj['html']=$str;
